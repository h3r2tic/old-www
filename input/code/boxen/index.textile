...
The game's engine is written from scratch in the D programming language. Naturally not all of its wheels are re-invented. Boxen utilizes the *Havok* library for physics, *FMOD* for sound, *OpenGL 3.2* and *CgFX* for graphics and *enet* for a reliable UDP layer. The networking component is based on an "authority scheme":http://webcache.googleusercontent.com/search?q=cache:EdJY39HKoHMJ:gafferongames.com/2008/02/27/gdc-slides-released/+http://gafferongames.com/conferences/migs09/&cd=1&hl=en&ct=clnk _(there are mirrors of the PDF on teh internets. "Here is one":/mirror/NetworkedPhysics-GDC2008.pdf for your convenience)_ enabling rich vehicle and kinetic controller dynamics.
